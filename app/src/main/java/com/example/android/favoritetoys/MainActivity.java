...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mToysListTextView = (TextView)findViewById(R.id.tv_toys_textview);
        ...
        String contentOfTextView="";
        for(String name:toysNames){
            contentOfTextView += name + "\n";
        }
        mToysListTextView.setText(contentOfTextView);
    }
}